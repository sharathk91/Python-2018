...
DATA_FILE = r'C:\Users\shara\PycharmProjects\DL_ICP2\Smoking.xls'
...
#create placeholders for input X1 (smoking status),label X2 (age classification),Y(number of cases)
...
with tf.Session() as sess:
    ...
    # assign the values of w and b
    w1,w2, b = sess.run([w1,w2, b])

# plot the results between Smoking status,Age classification & no of cases
